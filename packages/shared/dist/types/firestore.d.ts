import { Category, SlotType, OrgSubCollection, Collection } from "../enums/firestore";
 ...
 * are optional
 */
export declare type CustomerLoose = Omit<Omit<Customer, "id">, "secretKey"> & Partial<Pick<Customer, "id"> & Pick<Customer, "secretKey">>;
/**
 ...
 */
export declare type SlotAttendnace = {
    /**
