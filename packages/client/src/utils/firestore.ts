...
export const getAttendedSlotsPath: GetCollectionPath<[string]> = (
  organization,
  secretKey
) =>
  [
...
export const getAttendedSlotDocPath: GetDocumentPath<[string]> = (
  organization,
  secretKey,
  slotId
) => [getAttendedSlotsPath(organization, secretKey), slotId].join("/");
