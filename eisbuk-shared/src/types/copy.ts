...
import { Category, SlotType, Collection } from "../enums/firestore";

import {
  DeprecatedDuration,
  DeprecatedOrgSubCollection,
} from "../enums/deprecated/firestore";
 ...
 */
export type BookingInfo = ExtendedSlot<{ duration: DeprecatedDuration }>;
...
export interface BookingsByDay {
  [monthStr: string]: {
    [slotId: string]: {
      [customer_id: string]: DeprecatedDuration;
    };
  };
}
// ***** End Region Bookings ***** //
...
export interface EFirestoreSchema {
  [Collection.Organizations]: {
    [organization: string]: OrganizationMeta & {
      [DeprecatedOrgSubCollection.Slots]: { [slotId: string]: Slot };
      [DeprecatedOrgSubCollection.SlotsByDay]: {
